...
promise_test(async t => {
  ...
  _assertPixelApprox(canvas, 50,5, 0,255,0,255, 2);
  _assertPixelApprox(canvas, 100,5, 0,255,0,255, 2);
  _assertPixelApprox(canvas, 150,5, 0,255,0,255, 2);
  _assertPixelApprox(canvas, 200,5, 0,255,0,255, 2);
  // Without the last character.
  renderClusters(tm.getTextClusters(0, 4), 0, 100);
  _assertPixelApprox(canvas, 5,105, 0,255,0,255, 2);
  _assertPixelApprox(canvas, 50,105, 0,255,0,255, 2);
  _assertPixelApprox(canvas, 100,105, 0,255,0,255, 2);
  _assertPixelApprox(canvas, 150,105, 0,255,0,255, 2);
  _assertPixelApprox(canvas, 200,105, 255,0,0,255, 2);
  // Only the middle character.
  renderClusters(tm.getTextClusters(2, 3), 0, 150);
  _assertPixelApprox(canvas, 5,155, 255,0,0,255, 2);
  _assertPixelApprox(canvas, 50,155, 255,0,0,255, 2);
  _assertPixelApprox(canvas, 100,155, 0,255,0,255, 2);
  _assertPixelApprox(canvas, 150,155, 255,0,0,255, 2);
  _assertPixelApprox(canvas, 200,155, 255,0,0,255, 2);
